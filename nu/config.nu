...
source ~/.zoxide.nu
alias tgpt =  npx terminalgpt chat
alias peep =  py ~/Projects/peep/src/main.py
...
alias alacritty-config = nvim C:\Users\joshi\AppData\Roaming\alacritty\alacritty.yml
alias cd = z
